...
# quay.io/testnetworkfunction/cnf-certsuite-operator-bundle:$VERSION and quay.io/testnetworkfunction/cnf-certsuite-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/testnetworkfunction/cnf-certsuite-operator
