...
// +kubebuilder:rbac:groups=cnf-certifications.openshift.io,namespace=cnf-certsuite-operator,resources=cnfcertificationsuiteruns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cnf-certifications.openshift.io,namespace=cnf-certsuite-operator,resources=cnfcertificationsuiteruns/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cnf-certifications.openshift.io,namespace=cnf-certsuite-operator,resources=cnfcertificationsuiteruns/finalizers,verbs=update
